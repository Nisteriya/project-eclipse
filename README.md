...
Создание файла: создать test.txt "Привет мир" Файл создан

Просмотр содержимого: просмотреть test.txt Привет мир

Изменение файла: изменить test.txt "Новое содержимое" Файл изменен

Удаление файла: удалить test.txt Файл удален
